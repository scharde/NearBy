...
export const actionCreators = {
    updateFeedsAction: (): AppThunkAction<KnownAction> => (dispatch, getState) => {
        getDistanceFeeds()
          .then((result) => {
...
export const reducer: Reducer<FeedsState> = (state: FeedsState | undefined, incomingAction: Action) => {
